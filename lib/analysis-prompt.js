...
No markdown blocks (like \`\`\`json). No comments. No trailing commas. No text before or after JSON. Do not output <think> tags or private reasoning. No extra fields are allowed. Every field listed in the schema below must exist.
